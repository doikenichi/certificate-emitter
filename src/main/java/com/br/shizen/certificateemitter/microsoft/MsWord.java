...
public class MsWord {
     ...
     * @param substitutionData Hash map with the set of key-value pairs that represent
     *                         substitution data
     * @return
     */
    public static @NonNull Boolean generateDocx(String templateName, Map<String, String> substitutionData) {
     ...
     * @throws IOException
     */
    private static void zip(@NonNull File directory, File zipfile) throws IOException {
     ...
     * @throws IOException
     */
    public static void deleteTempData(@NonNull File file) throws IOException {
    ...
    private static void copy(@NonNull InputStream in, OutputStream out) throws IOException {
